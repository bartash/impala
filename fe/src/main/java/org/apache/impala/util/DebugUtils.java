...
public class DebugUtils {
  ...
  // debug action label for throwing an exception when committing an Iceberg transaction.
  public static final String ICEBERG_COMMIT = "catalogd_iceberg_commit"; // FIXE change name to update_catalog_iceberg_commit or similar
        ...
        case "EXCEPTION":
          ...
          switch (exceptionClazz.toLowerCase()) {
            case "commitfailedexception":
              ...
              break;
            default:
              LOG.error("Debug action exception class {} is not implemented", exceptionClazz);
              break;
          }
